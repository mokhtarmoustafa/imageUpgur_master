...
import dev.mokhtar0.upgur.data.config.Config
import dev.mokhtar0.upgur.data.config.Config.IMGUR_API_BASE_URL
import dev.mokhtar0.upgur.data.config.Config.IMGUR_OAUTH2_API_BASE_URL
